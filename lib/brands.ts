...
export const FEATURED_BRANDS: FeaturedBrand[] = [
  ...
  { name: "Barbour", slug: "barbour", query: "Barbour", sells: "waxed jackets & country wear",
    blurb: "Barbour is the British heritage brand behind the waxed Bedale and Beaufort jackets, plus quilted coats and country clothing.",
    examples: ["Barbour jacket", "Barbour wax jacket"] },
  { name: "Superdry", slug: "superdry", query: "Superdry", sells: "casual clothing",
    blurb: "Superdry blends vintage Americana and Japanese-inspired graphics across jackets, hoodies and tees.",
    examples: ["Superdry jacket", "Superdry hoodie"] },
  { name: "Fred Perry", slug: "fred-perry", query: "Fred Perry", sells: "polo shirts & casual wear",
    blurb: "Fred Perry, with its laurel-wreath logo, is known for the tennis-born twin-tipped polo shirt and mod-rooted style.",
    examples: ["Fred Perry polo", "Fred Perry jacket"] },
  { name: "Champion", slug: "champion", query: "Champion", sells: "sportswear",
    blurb: "Champion is the American sportswear label famous for reverse-weave hoodies, sweats and the script logo.",
    examples: ["Champion hoodie", "Champion sweatshirt"] },
  { name: "Ellesse", slug: "ellesse", query: "Ellesse", sells: "sportswear",
    blurb: "Ellesse is an Italian sportswear brand with retro tennis and ski heritage — tracksuits, tees and trainers.",
    examples: ["Ellesse tracksuit", "Ellesse t-shirt"] },
  { name: "Fila", slug: "fila", query: "Fila", sells: "sportswear & trainers",
    blurb: "Fila pairs Italian sportswear heritage with chunky trainers like the Disruptor and retro apparel.",
    examples: ["Fila trainers", "Fila Disruptor"] },
  { name: "Crocs", slug: "crocs", query: "Crocs", sells: "clogs & sandals",
    blurb: "Crocs makes the instantly recognisable foam clog, plus sandals and Jibbitz charms.",
    examples: ["Crocs"] },
  { name: "Birkenstock", slug: "birkenstock", query: "Birkenstock", sells: "sandals",
    blurb: "Birkenstock is known for contoured cork-footbed sandals like the Arizona and Boston clog.",
    examples: ["Birkenstock sandals", "Birkenstock Boston"] },
  { name: "Skechers", slug: "skechers", query: "Skechers", sells: "comfort trainers",
    blurb: "Skechers focuses on cushioned, comfort-first trainers and walking shoes for everyday wear.",
    examples: ["Skechers trainers"] },
  { name: "Hugo Boss", slug: "hugo-boss", query: "Hugo Boss", sells: "smart & casual clothing",
    blurb: "Hugo Boss offers tailored suits, smart-casual menswear and accessories with a modern edge.",
    examples: ["Hugo Boss jacket", "Boss t-shirt"] },
  { name: "Calvin Klein", slug: "calvin-klein", query: "Calvin Klein", sells: "minimal clothing & underwear",
    blurb: "Calvin Klein is known for clean, minimal clothing, denim and its iconic logo underwear.",
    examples: ["Calvin Klein jeans", "Calvin Klein underwear"] },
  { name: "Diesel", slug: "diesel", query: "Diesel", sells: "denim & streetwear",
    blurb: "Diesel is an Italian denim-led label known for bold jeans, jackets and logo pieces.",
    examples: ["Diesel jeans", "Diesel t-shirt"] },
];
