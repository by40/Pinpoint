    ...
    <div className="min-h-screen bg-bg text-ink">
      ...
      <main className="max-w-2xl mx-auto px-6 py-14">
        ...
        <p className="text-sm text-muted leading-relaxed mb-10">
          Pinpoint is built to be private by default. There are <strong className="text-ink font-semibold">no accounts,
        ...
        <Section title="What Pinpoint accesses">
          <p>
            <strong className="text-ink font-semibold">Your location</strong> — only when you tap &ldquo;Find Shops&rdquo; or
          ...
          <p>
            <strong className="text-ink font-semibold">What you type</strong> — the item you search for is sent with
            your coordinates to fetch results (see below). It isn&apos;t saved on any server we control.
          </p>
          <p>
            <strong className="text-ink font-semibold">Your wishlist &amp; sound preference</strong> — these live only
        ...
        <Section title="Where your data goes">
          ...
          <ul className="list-disc pl-5 space-y-1.5">
            <li>
              <strong className="text-ink font-semibold">OpenStreetMap / Overpass API</strong> — receives your
              coordinates and query to find matching shops nearby.{" "}
              <a href="https://wiki.osmfoundation.org/wiki/Privacy_Policy" target="_blank" rel="noopener noreferrer" className="text-ink underline underline-offset-2 hover:text-muted">
                Their privacy policy
              </a>
              .
            </li>
            <li>
              <strong className="text-ink font-semibold">OpenFreeMap</strong> — serves the map tiles you see, based
              on the area you&apos;re viewing.{" "}
              <a href="https://openfreemap.org/" target="_blank" rel="noopener noreferrer" className="text-ink underline underline-offset-2 hover:text-muted">
                openfreemap.org
              </a>
              .
            </li>
        ...
        <Section title="Analytics">
          <p>
            ...
            <strong className="text-ink font-semibold">Vercel Web Analytics and Speed Insights</strong>. These are
            privacy-focused and <strong className="text-ink font-semibold">do not use cookies</strong>, do not
            ...
            <a href="https://vercel.com/docs/analytics/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-ink underline underline-offset-2 hover:text-muted">
        ...
        <Section title="Accuracy of results">
          <p>
            Pinpoint shows nearby shops <strong className="text-ink font-semibold">likely</strong> to sell a brand or
